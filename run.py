...
#==========================helper funtions================
def helper(dis):
    desc = df_description[df_description['Disease'] == dis]['Description']
    desc = " ".join([w for w in desc])

    pre = df_precautions[df_precautions['Disease'] == dis][['Precaution_1', 'Precaution_2', 'Precaution_3', 'Precaution_4']]
    pre = [col for col in pre.values]

    med = df_medications[df_medications['Disease'] == dis]['Medication']
    med = [med for med in med.values]

    die = df_diets[df_diets['Disease'] == dis]['Diet']
